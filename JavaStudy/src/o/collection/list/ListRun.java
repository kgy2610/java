...
public class ListRun {
 	...
 	* 배열의 단점과 컬렉션의 장점
 	 > 배열의 단점
 	 	1. 배열은 크기를 지정해야한다.
 	 	   새로운 값을 더 추가하고자 한다면, 새로운 배열을 만들고 기존의 값을 전부 복사하는 코드를 작성해야한다.
	...
	public static void main(String[] args) {
		// ArrayList list
			List list = new ArrayList(10); // 크기지정을 할 수도 있고 안해도 괜찮다.
			
			System.out.println(list); // 비어있는 상태 | list.size() -> 사용된 공간의 크기를 알 수 있다
			...
			System.out.println(list); // list의 특징 : 순서를 유지하면서 당김(0번 인덱스부터 차곡차곡)
