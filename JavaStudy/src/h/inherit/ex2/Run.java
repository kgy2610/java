...
public class Run {
	 ...
	 * - 코드를 공통으로 관리하기 때문에 코드의 추가나 변경이 용이하다(유지보수서잉 좋음)
	 * 
	 * 상속의 특징
	 ...
	 * -> Object에 있는 메소드를 마음대로 호풀해서 사용할 수 있다.
	 * -> 오버라이딩도 가능하다.      
	 * 
	 * 방법
	 * extentds 키워드 사용
	...
	public static void main(String[] args) {
		...
		//Product클래스를 상속받는 Desktop 객체를 생성
		//boolean allinOne

		Desktop d1 = new Desktop ("LG","100","사무용PC",100000,true);
